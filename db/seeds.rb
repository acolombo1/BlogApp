...
first_user = User.create(name: 'Tom', photo: 'https://acolombo1.github.io/Portfolio/foto1.jpg', bio: 'Teacher from Mexico.')
second_user = User.create(name: 'Lilly', bio: 'Teacher from Poland.')
...
Post.create(author: first_user, title: 'Post nr 3', text: 'This is my 3rd post')
Post.create(author: first_user, title: 'Post nr 4', text: 'This is my 4th post')
